...
public class UCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lib_img_crop_ucrop_activity_photobox);
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        if (menuItemLoaderIcon != null) {
            try {
                ...
                Log.i(TAG, String.format("%s - %s", e.getMessage(), getString(R.string.lib_img_crop_mutate_exception_hint)));
            }
    ...
    private void setImageData(@NonNull Intent intent) {
        ...
        if (inputUri != null && outputUri != null) {
            ...
            setResultError(new NullPointerException(getString(R.string.lib_img_crop_error_input_data_is_absent)));
            finish();
        }
    }
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mToolbarTitle = mToolbarTitle != null ? mToolbarTitle : getResources().getString(R.string.lib_img_crop_label_edit_photo);
        ...
        if (mShowBottomControls) {
            ...
            LayoutInflater.from(this).inflate(R.layout.lib_img_crop_ucrop_controls, wrapper, true);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        if (aspectRatioList == null || aspectRatioList.isEmpty()) {
            ...
            aspectRatioList.add(new AspectRatio(getString(R.string.lib_img_crop_label_original).toUpperCase(),
        ...
        for (AspectRatio aspectRatio : aspectRatioList) {
            wrapperAspectRatio = (FrameLayout) getLayoutInflater().inflate(R.layout.lib_img_crop_ucrop_aspect_ratio, null);
